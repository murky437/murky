...
func TestGetProjectListSuccess(t *testing.T) {
	...
	var resp project.ProjectListResponse
	err = json.Unmarshal(rr.Body.Bytes(), &resp)
	require.NoError(t, err)

	require.Equal(t, []project.ProjectListItem{
		project.ProjectListItem{Title: "Project 1", Slug: "project-1"},
		project.ProjectListItem{Title: "Project 2", Slug: "project-2"},
		project.ProjectListItem{Title: "Project 3", Slug: "project-3"},
	}, resp.Data)
}
